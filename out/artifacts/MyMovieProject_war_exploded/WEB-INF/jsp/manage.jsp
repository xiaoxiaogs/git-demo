...
<head>
    ...
    <link href="${pageContext.servletContext.contextPath}/static/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <link href="${pageContext.servletContext.contextPath}/static/bootstrap/css/bootstrap.css" rel="stylesheet">
    <script src="${pageContext.servletContext.contextPath}/static/bootstrap/js/jquery-3.3.1.min.js"></script>
    <script src="${pageContext.servletContext.contextPath}/static/bootstrap/js/bootstrap.min.js"></script>
    <link rel="icon" type="image/x-icon" href="${pageContext.servletContext.contextPath}/static/images/logo.ico"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/static/css/header.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/static/css/main.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/static/css/manage.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath}/static/css/footer.css">
    <script src="${pageContext.servletContext.contextPath}/static/js/header.js" charset="utf-8"></script>
    <script src="${pageContext.servletContext.contextPath}/static/js/echarts.js"></script>
    <script src="${pageContext.servletContext.contextPath}/static/js/Api.js"></script>
    <script src="${pageContext.servletContext.contextPath}/static/layui/layui.js" charset="utf-8"></script>
    <link rel="stylesheet" href="${pageContext.servletContext.contextPath}/static/layui/css/layui.css" media="all">
