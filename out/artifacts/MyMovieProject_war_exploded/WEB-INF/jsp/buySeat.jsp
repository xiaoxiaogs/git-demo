...
<script>
    ...
    location.href="${pageContext.servletContext.contextPath}/pay?movieName=${movie.movieCnName}&prices="+price+"&position="+arr+"&price=${schedule.schedulePrice}&schduleId=${schedule.scheduleId}";
    }
</script>