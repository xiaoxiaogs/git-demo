...
<html><!--<![endif]--><head>
  ...
  <link href="${pageContext.servletContext.contextPath}/static/js/jquery-3.3.1.min.js">
...
<div class="subnav">
  <ul class="navbar">
    ...
    <li>
      <a href="${pageContext.servletContext.contextPath}/movieList">即将上映</a>
    </li>
    <li>
  ...
  <div class="tags-panel">
    <ul class="tags-lines">
      <li class="tags-line" data-val="{tagTypeName:'cat'}">
        ...
        <ul class="tags">
          <li class="active">
            <a href="javascript:void(0);" style="cursor: default">全部</a>
          </li>
          <c:forEach items="${allType}" var="a">
            <li>
              <a href="movieList1?typeId=${a.movieTypeId}">${a.movieTypeName}</a>
            </li>
          </c:forEach>
        </ul>
      </li>
      <li class="tags-line tags-line-border" data-val="{tagTypeName:'source'}">
        ...
        <ul class="tags">
          <li class="${address=="" ? "active" : ""}" data-state-val="{ sourceTagName:'全部'}">
            <a data-act="tag-click" data-val="{TagName:'全部'}" href="movieList1?pageNum=${current}" style="cursor: default">全部</a>
          </li>
          <c:forEach items="${all}" var="list">
            <li class="${address==list.movieCountry ? "active" : ""}">
              <a href="movieList1?address=${list.movieCountry}">${list.movieCountry}</a>
            </li>
          </c:forEach>
        </ul>
      </li>
  ...
  <div class="movies-panel">
    <div class="movies-sorter">
      ...
      <div class="play-sorter">
        <span class="sort-control-group" data-act="isplay-click" data-val="{isplay:1}" data-href="?showType=1&amp;isPlay=1" onclick="location.href=this.getAttribute('data-href')">
...
<%--      电影所有数据--%>
      ...
      <dd>
        <div class="movie-item film-channel">
          ...
          <div class="movie-item-hover">
            <a href="movieDetail?movieId=${a.movieId}" target="_blank" data-act="movie-click" data-val="{movieid:1451694}">
              <img class="movie-hover-img" src="${pageContext.servletContext.contextPath}/static/images/show/${a.moviePicture}" alt="${a.movieCnName}">
              <div class="movie-hover-info">
                <div class="movie-hover-title" title="${a.movieCnName}">
                  <span class="name ">${a.movieCnName}</span>
                  <span class="score channel-detail-orange">
                    <i class="integer">
                        ${a.movieScore}
                    </i>
                  </span>
                ...
                <div class="movie-hover-title movie-hover-brief" title="${a.movieCnName}">
        ...
        <div class="channel-detail movie-item-title" title="${a.movieCnName}">
          <a href="#" target="_blank" data-act="movies-click" data-val="{movieId:1451694}">${a.movieCnName}</a>
        </div>
        <div class="channel-detail channel-detail-orange">
          <i class="integer">${a.movieScore}</i>
        </div>
  ...
  <ul class="list-pager">
    ...
    <c:if test="${current!=1}">
    <li>
      <a class="page_2" href="movieList1?pageNum=${current-1}
