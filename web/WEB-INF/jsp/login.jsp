...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="${pageContext.servletContext.contextPath}/static/images/maoyan.jpg"/>
    <link href="static/css/login.css" rel="stylesheet">

    <script></script>
    <title>猫眼电影-登录注册</title>
</head>
<!--
...
<!-- ------------------------------------------------------------------- -->
<div class="screen">
    <img src="static/images/111.jpg"><br/>
    <label class="title">猫 眼 电 影</label><br/>
...
<script>
    ...
    //登录账号和密码信息验证
    function loginbtn(){
        var user_name = $(".login_page").find("#user_name").val();
        var user_pwd = $(".login_page").find("#user_pwd").val();
    ...
    function registerbtn(){
        var textNum = document.getElementById('TestNum');
        var user_name = $(".register_page").find("#user_name").val();
        var user_pwd = $(".register_page").find("#user_pwd").val();
        var user_email = $(".register_page").find("#user_email").val();
        ...
        if((user_name == "") || (user_pwd == "") || (user_email == "")){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.msg == "success"){
                        window.alert("注册成功！");
                        window.location.href="${pageContext.servletContext.contextPath}/login1";
