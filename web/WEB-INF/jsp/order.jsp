...
<div id="wrap">
    ...
    <div class="leftMeun" id="leftMeun">
        ...
        <div class="meun-item meun-item-active" href="#user" aria-controls="user" role="tab" data-toggle="tab">订单管理</div>
            ...
            <div role="tabpanel" class="tab-pane active" id="user">
                <div class="check-div form-inline" style="position: relative;">
                    <div style="position: absolute; right: 0;">
                        <input type="text" class="form-control input-sm" id="search" placeholder="输入用户名搜索">
                        <button class="btn btn-white btn-xs " name="uid" onclick="abcd()">查 询 </button>
                    </div>
                </div>
                <div class="data-div">
                ...
                <footer class="footer">
                    <ul class="clearfix">
                        <c:if test="${current!=1}">
                            ...
                            <li><a href="order?pageNum=${current-1}
                                 <c:if test="${userId!=null}">
                                     &userId=${userId}
                                 </c:if>
                            ">上一页</a></li>
...
<script>
    ...
    function abcd(){
        ...
        location.href="order?userId="+name;
    }
